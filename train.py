...
def main():
    ...
    with tf.Session() as sess:
        ...
        if args.is_train:
            ...
            checkimage(label_merge /(1e3*1e-5) ,'label_debug.bmp')
            checkimage(result_lr /(1e3*1e-5),'bicubic_debug.bmp')
            ...
            print('__debug__residual_norm',residual/(1e3*1e-5))
